#!/bin/bash
#SBATCH --job-name=sparsediff_ego_novel
...
python3 main.py +experiment=ego dataset=ego train.n_epochs=100 +trainer.accelerator=gpu +trainer.devices=1 general.wandb=disabled general.name=ego_novel general.use_novel_sampling=true
